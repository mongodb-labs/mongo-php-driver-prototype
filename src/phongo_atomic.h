...
int32_t
_phongo_emul_atomic_int32_fetch_add (int32_t volatile *val, int32_t v, enum phongo_memory_order);

int32_t
_phongo_emul_atomic_int32_exchange (int32_t volatile *val, int32_t v, enum phongo_memory_order);

int32_t
_phongo_emul_atomic_int32_compare_exchange_strong (int32_t volatile *val,
                                                 int32_t expect_value,
                                                 int32_t new_value,
                                                 enum phongo_memory_order);

int32_t
_phongo_emul_atomic_int32_compare_exchange_weak (int32_t volatile *val,
                                               int32_t expect_value,
                                               int32_t new_value,
                                               enum phongo_memory_order);
...
phongo_atomic_int32_fetch (const int32_t volatile *val, enum phongo_memory_order order)
{
   return _phongo_emul_atomic_int32_fetch_add ((int32_t volatile *) val, 0, order);
}

static BSON_INLINE int32_t
phongo_atomic_int32_fetch_add (int32_t volatile *val, int32_t v, enum phongo_memory_order order)
{
   return _phongo_emul_atomic_int32_fetch_add (val, v, order);
}

static BSON_INLINE int32_t
phongo_atomic_int32_fetch_sub (int32_t volatile *val, int32_t v, enum phongo_memory_order order)
{
   return _phongo_emul_atomic_int32_fetch_add (val, -v, order);
}

static BSON_INLINE int32_t
phongo_atomic_int32_exchange (int32_t volatile *val, int32_t v, enum phongo_memory_order order)
{
   return _phongo_emul_atomic_int32_exchange (val, v, order);
}

static BSON_INLINE int32_t
phongo_atomic_int32_compare_exchange_strong (int32_t volatile *val,
                                           int32_t expect_value,
                                           int32_t new_value,
...
static BSON_INLINE int32_t
phongo_atomic_int32_compare_exchange_weak (int32_t volatile *val,
                                         int32_t expect_value,
                                         int32_t new_value,
                                         enum phongo_memory_order order)
{
